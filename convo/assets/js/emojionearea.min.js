...
window = "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, document = window.document || {},
    function (a, b) {
        ...
        function o(a, b, c) {
            ...
            var h = "";
            return k > 4 ? (h = b.uc_base, b = b.uc_output.toUpperCase()) : h = b, a.replace("{name}", c || "").replace("{friendlyName}", g).replace("{img}", f + (k < 2 ? h.toUpperCase() : h) + "." + d).replace("{uni}", b).replace("{alt}", e.convert(b))
        }
        ...
        function y(a, b) {
            return a = a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/`/g, "&#x60;").replace(/(?:\r\n|\r|\n)/g, "\n").replace(/(\n+)/g, "<div>$1</div>").replace(/\n/g, "<br/>").replace(/<br\/><\/div>/g, "</div>"), b.shortnames && (a = e.shortnameToUnicode(a)), x(a, b.emojiTemplate).replace(/\t/g, "&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g, "&nbsp;&nbsp;")
        }

        function z(a, b) {
            switch (a = a.replace(/<img[^>]*alt="([^"]+)"[^>]*>/gi, "$1").replace(/\n|\r/g, "").replace(/<br[^>]*>/gi, "\n").replace(/(?:<(?:div|p|ol|ul|li|pre|code|object)[^>]*>)+/gi, "<div>").replace(/(?:<\/(?:div|p|ol|ul|li|pre|code|object)>)+/gi, "</div>").replace(/\n<div><\/div>/gi, "\n").replace(/<div><\/div>\n/gi, "\n").replace(/(?:<div>)+<\/div>/gi, "\n").replace(/([^\n])<\/div><div>/gi, "$1\n").replace(/(?:<\/div>)+/gi, "</div>").replace(/([^\n])<\/div>([^\n])/gi, "$1\n$2").replace(/<\/div>/gi, "").replace(/([^\n])<div>/gi, "$1\n").replace(/\n<div>/gi, "\n").replace(/<div>\n/gi, "\n\n").replace(/<(?:[^>]+)?>/g, "").replace(new RegExp(l, "g"), "").replace(/&nbsp;/g, " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"').replace(/&#x27;/g, "'").replace(/&#x60;/g, "`").replace(/&amp;/g, "&"), b.saveEmojisAs) {
                case "image":
        ...
        function F(b) {
            ...
            if (!b.recent || b.recent !== c) {
                if (c.length) {
                    var d = b.scrollArea.is(".skinnable"),
                        e, f;
                    d || (e = b.scrollArea.scrollTop(), f = b.recentCategory.is(":visible") ? b.recentCategory.height() : 0);
                    var g = p(c, b.emojiBtnTemplate, !0).split("|").join("");
                    if (b.recentCategory.children(".emojibtn").remove(), a(g).insertAfter(b.recentCategory.children("h1")), b.recentCategory.children(".emojibtn").on("click", function () {
                            b.trigger("emojibtn.click", a(this))
                        }), b.recentFilter.show(), !d) {
        ...
        function G(a, b) {
            var c = E(),
                d = c.split("|"),
                e = d.indexOf(b);
            e !== -1 && d.splice(e, 1), d.unshift(b), d.length > 9 && d.pop(), localStorage.setItem("recent_emojis", d.join("|")), F(a)
        }
        ...
        function I(b, c, d) {
            ...
            if (b.searchSel = null, i.data(c.data()), a.each(d.attributes, function (a, b) {
                    ...
                    if ("recent" !== c || b.recentEmojis) {
                        ...
                        do {
                            ...
                            f > 0 && (g.hide(), h = h.split("|").join("_tone" + f + "|") + "_tone" + f), "recent" === c && (h = E()), h = p(h, b.sprite ? '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><i class="emojione-{uni}"></i></i>' : '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><img class="emojioneemoji lazy-emoji" data-src="{img}"/></i>', !0).split("|").join(""), g.html(h), a("<h1/>").text(e.title).prependTo(g)
                        } while (--f > 0)
                    }
                }), d.filters = null, b.sprite || (b.lasyEmoji = K.find(".lazy-emoji")), I = x.find(C("filter")), I.eq(0).addClass("active"), L = K.find(C("category")), b.recentFilter = I.filter('[data-filter="recent"]'), b.recentCategory = L.filter("[name=recent]"), b.scrollArea = M, d.container ? a(d.container).wrapInner(N) : N.insertAfter(c), d.hideSource && c.hide(), b.setText(c[g]()), c[g](b.getText()), A.apply(b), b.standalone && !b.getText().length) {
            ...
            if (M.on("scroll", function () {
                    if (!P && (B.call(b), M.is(":not(.skinnable)"))) {
                        var c = L.eq(0),
                            d = M.offset().top;
                        L.each(function (b, e) {
                        ...
                        e[0] && !e.is(".active") && (I.removeClass("active"), e.addClass("active"))
                    }
                    ...
                    P = !0, c || (I.filter(".active").removeClass("active"), a.addClass("active"));
                    ...
                    b.recentEmojis && F(b), B.call(b)
                }).on("@tone.click", function (a) {
                    w.children().removeClass("active");
                    var c = a.addClass("active").data("skin");
                    c ? (M.addClass("skinnable"), L.hide().filter("[data-tone=" + c + "]").show(), I.eq(0).is('.active[data-filter="recent"]') && I.eq(0).removeClass("active").next().addClass("active")) : (M.removeClass("skinnable"), L.hide().filter("[data-tone=0]").show(), I.eq(0).click()), B.call(b)
                    ...
                    var e = function (d) {
                        ...
                        var g = a("#" + e),
                            ...
                            j = c.height();
                        (h + i >= j || h > i) && c.scrollTop(h + i - 2 * j / 3), g.remove(), b.stayFocused = !1, A.apply(b), m(b, "paste", [c, d, f])
                    };
                    ...
                    i.removeClass("has-placeholder"), null !== b.searchSel && (i.focus(), v(i[0], b.searchSel), b.searchSel = null), b.standalone ? (i.html(p(a.data("name"), b.emojiTemplate)), b.trigger("blur")) : (u(i[0]), q(p(a.data("name"), b.emojiTemplate))), b.recentEmojis && G(b, a.data("name")), b.search.val(""), b.trigger("search.keypress")
                }).on("@!resize @keyup @emojibtn.click", A).on("@!mousedown", function (c, d) {
                    return a(d.target).hasClass("search") ? (b.stayFocused = !0, null == b.searchSel && (b.searchSel = u(c[0]))) : (N.is(".focused") || c.focus(), d.preventDefault()), !1
                }).on("@change", function () {
                    ...
                    var a = b.editor.html();
                    b.content !== a ? (b.content = a, m(b, "change", [b.editor]), c.blur().trigger("change")) : c.blur(), b.search.val(""), b.trigger("search.keypress")
                    ...
                    "" !== d ? (L.filter('[data-tone="' + w.find("i.active").data("skin") + '"]:not([name="recent"])').each(function () {
                        ...
                        if (0 === e.length) b.hide(), c.filter('[data-filter="' + b.attr("name") + '"]').hide();
                        else {
                            var f = b.find('.emojibtn:not([data-name*="' + d + '"])');
                            f.hide(), e.show(), b.show(), c.filter('[data-filter="' + b.attr("name") + '"]').show()
                        }
                    }), P ? B.call(b) : M.trigger("scroll")) : (L.filter('[data-tone="' + w.find("i.active").data("skin") + '"]:not([name="recent"])').show(), a(".emojibtn", L).show(), c.show())
        ...
        function L(b) {
            ...
            if (b = t(b), !K.isLoading)
                if (!e || d(c(e)) < 2) {
                    K.isLoading = !0;
                    var h;
                    h = d(J) > 5 ? K.defaultBase3 + "npm/emojione@" + J : d(J) > 4 ? K.defaultBase3 + "emojione/" + J : K.defaultBase + "/" + J, a.getScript(h + "/lib/js/emojione.min.js", function () {
                        e = window.emojione, J = c(e), k = d(J);
                        var g;
                        k > 4 ? (K.base = K.defaultBase3 + "emojione/assets/" + J, g = K.base + "/sprites/emojione-sprite-" + e.emojiSize + ".css") : (K.base = K.defaultBase + J + "/assets", g = K.base + "/sprites/emojione.sprites.css"), b.sprite && (document.createStyleSheet ? document.createStyleSheet(g) : a("<link/>", {
                            rel: "stylesheet",
                            href: g
                        }).appendTo("head"));
                ...
                } else J = c(e), k = d(J), k > 4 ? K.base = K.defaultBase3 + "emojione/assets/" + J : K.base = K.defaultBase + J + "/assets";
            g(function () {
                var a = "";
                b.useInternalCDN && (k > 4 && (a = e.emojiSize + "/"), e.imagePathPNG = K.base + "/png/" + a, e.imagePathSVG = K.base + "/svg/" + a, e.imagePathSVGSprites = K.base + "/sprites/emojione.sprites.svg", e.imageType = b.imageType), d(J) > 4 ? (w = e.regUnicode, e.imageType = b.imageType || "png") : w = new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + e.unicodeRegexp + ")", "gi")
            })
        }
        var M = function (a, e) {
            var f = this;
            L(e), c[f.id = ++b] = {}, d[f.id] = {}, g(function () {
                I(f, a, e)
            })
        };
        ...
        M.prototype.on = function (b, d) {
            if (b && a.isFunction(d)) {
                ...
                a.each(b.toLowerCase().split(" "), function (a, b) {
                    N(e, b), (c[e.id][b] || (c[e.id][b] = [])).push(d)
                })
            }
            return this
            ...
            var b = this;
            return g(function () {
                b.editor.html(y(a, b)), b.content = b.editor.html(), m(b, "change", [b.editor]), A.apply(b)
            }), b
            ...
            var a = this;
            return g(function () {
                a.editor.prop("contenteditable", !0), a.button.show()
            }), a
        }, M.prototype.disable = function () {
            var a = this;
            return g(function () {
                a.editor.prop("contenteditable", !1),
                    a.hidePicker(), a.button.hide()
            }), a
        }, a.fn.emojioneArea = function (b) {
            return this.each(function () {
                return this.emojioneArea ? this.emojioneArea : (a.data(this, "emojioneArea", this.emojioneArea = new M(a(this), b)), this.emojioneArea)
            })
        }, a.fn.emojioneArea.defaults = r(), a.fn.emojioneAreaText = function (b) {
            var c = this,
                d = {
            ...
            return L(b), g(function () {
                c.each(function () {
                    var b = a(this);
                    return b.hasClass("emojionearea-text") || b.addClass("emojionearea-text").html(y(b.is("TEXTAREA") || b.is("INPUT") ? b.val() : b.text(), d)), b
                })
            }), this
        }
    }, window);
